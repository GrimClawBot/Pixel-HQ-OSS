...
- Mission Control overview freshness uses exact decimal ordering, stale responses cannot overwrite fresher state, and oversized or malformed projections fail closed.
